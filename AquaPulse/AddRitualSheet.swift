...
struct AddRitualSheet: View {
    ...
    private let symbols = ["star.fill", "heart.fill", "leaf.fill", "dumbbell.fill", "brain.head.profile", "fork.knife", "music.note", "paintbrush.fill", "play.rectangle.fill", "waveform", "photo.artframe", "sparkles"]
